...
$(function(){
    ...
    var myOption = {
        'data': {
            'title': ['科室名称', '科室总人数', '医生人数', '护士人数', '床位', '医生出勤率'],
            'content': [ 
                ['妇科', '42', '21', '19', '45' , '45.6%'], 
                ['皮肤科', '42', '21', '19', '45' , '45.6%'],
                ['眼科', '42', '21', '19', '45' , '45.6%'], 
                ['烧伤科', '42', '21', '19', '45' , '45.6%'],
                ['神经外科', '42', '21', '19', '45' , '45.6%'], 
                ['产科', '42', '21', '19', '45' , '45.6%'],
                ['儿科', '42', '21', '19', '45' , '45.6%'],
            ]
        }
    ...
    var data = {
        ...
        data: [
            {
                value: [87, 59, 45, 39, 80] 
                //name: '某软件'
            },
        ]
    };
    var radar = new RadarChart();
    radar.init({dom:domRadar[0]});
    radar.render(data);
