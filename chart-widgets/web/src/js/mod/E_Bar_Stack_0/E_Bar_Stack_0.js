// define(['./E_Base'], function (E_Base) {
    ...
    /**
     *  desc: 堆叠柱形图
     *  className: E_Bar_Stack_1
     *  auth: gaok
     */
    
    var E_Bar_Stack_1 = function () {
        if (!(this instanceof E_Bar_Stack_1)) {
            return new E_Bar_Stack_1();
        }
    }
    E_Bar_Stack_1.prototype = $.extend(new E_Base(), {
        version: '0.0.1',
        defaultOption:{
            title: {
                text: '世界人口总量',
            ...
            series: [
                ...
                },
                {
                    ...
                    type: 'bar',
                    stack: '总量',
                    data: [1820, 2348, 2904, 14970, 13144, 63030]
                },
                {
                    name: 'baz',
                    type: 'bar',
                    stack: '总量',
                    data: [203, 239, 290, 1049,31744, 230]
                }
            ]
        },
        /**
