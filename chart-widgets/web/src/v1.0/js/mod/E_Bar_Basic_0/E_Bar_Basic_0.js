...
function E_Bar_Basic_0(){}
/**
 * desc: 初始化基础条形图 
 */

E_Bar_Basic_0.prototype.init = function(opt){
    this._dom = opt.dom||''
 ...
 */
 ...
 E_Bar_Basic_0.prototype.render = function(data){
    this.setTitle(data)
...
E_Bar_Basic_0.prototype.setTitle = function(data){
 ...
 * desc: 设置X轴标签
 */
E_Bar_Basic_0.prototype.setXAxisLabel = function(data){
    var option = this.chart.getOption();
 ...
 * desc: 设置X轴数据
 */
E_Bar_Basic_0.prototype.setYAxisData = function(data){
    var option = this.chart.getOption();
 ...
 *  desc: 设置Y轴标签
 */
E_Bar_Basic_0.prototype.setYAxisLabel = function(data){
    var option = this.chart.getOption();
 ...
 * desc: 设置Y轴数据
 */
E_Bar_Basic_0.prototype.setXAxisData = function(data,index){
 ...
 * desc: 设置图例
 */
E_Bar_Basic_0.prototype.setLegend = function(data){
    var option = this.chart.getOption();
